...
## 1. Project Overview
A specialized Digital Humanities framework designed to visualize complex historical datasets. The application uses a **reactive data pipeline** where raw GeoJSON data is filtered, sanitized, and aggregated in real-time before reaching the map interface.

**Tech Stack:** React 18, TypeScript, MapLibre GL, Material UI (MUI), Vite.

---

## 2. Architecture: The Reactive Pipeline
Data flows in a unidirectional stream. The map never reads raw data; it only reads data processed by the **Selectors**.
...
### 3. The Registry Pattern: Making the App Extensible
